...
class Renderer {
  ...
  init(canvas, quality = "medium") {
    ...
    this.originalFog = { near: 50, far: 150, color: 0x1a1a2e };
    this.originalBackground = 0x1a1a2e;
  ...
  setupLights() {
    ...
    // 半球光（天空/地面）
    this.hemisphereLight = new THREE.HemisphereLight(0x8888ff, 0x444422, 0.4);
    this.scene.add(this.hemisphereLight);

    this.originalLightState = {
      ambient: { intensity: 0.6, color: 0x404060 },
      directional: { intensity: 0.8, color: 0xffffff },
      hemisphere: { intensity: 0.4, skyColor: 0x8888ff, groundColor: 0x444422 },
    };
  }

...
class Game {
  ...
  startGame() {
    ...
    this.ui.updateEquipmentPanel(this.player);
  ...
  handleDialogOption(option) {
    ...
    switch (action) {
      ...
      case "openShop":
        this.ui.hideDialog();
        this.ui.openShop(this.currentNPC, "buy");
        break;

      case "openSell":
        this.ui.hideDialog();
        this.ui.openShop(this.currentNPC, "sell");
        break;

      case "openRepair":
        this.ui.hideDialog();
        this.ui.openShop(this.currentNPC, "repair");
        break;
  ...
  handleItemClick(item, index) {
    ...
    if (item.type === "consumable") {
      ...
      const result = this.player.equipItem(item.id);
      if (result.success) {
        this.ui.showToast(result.message, "success");
        this.ui.updateInventoryPanel(this.player);
        this.ui.updateCharacterPanel(this.player);
